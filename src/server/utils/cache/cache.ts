import type { RichSuggestion } from "../../types/extension";
import type { EngineTiming, SearchResult } from "../../../shared/search-types";
import { logger } from "../logger";
import { THREAT_LEVEL } from "../security/sentinel";
import {
  INVALIDATE_SCOPE,
  isValkeyEnabled,
  kvDel,
