...
import type { EventHandler, VNode } from "../../../shared/ui/core/types";
...
export const extCardConfigureNode = (
  ...
  ext.configurable ? (
    <Button variant="secondary" class="ext-card-configure" data-id={ext.id} onClick={onClick}>
...
export const extCardRestartWarningNode = (ext: ExtensionMeta): VNode | null =>
  ext.needsAppRestart ? (
    <Badge modifier="restart-required" tooltip={t("settings-page.extensions.restart-required")}>
